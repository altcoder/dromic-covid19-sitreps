# Contributing to dromic-covid19-sitreps

Love dromic-covid19-sitreps and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/altcoder/dromic-covid19-sitreps/issues) is
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
   ...
   git clone https://github.com/<your-username>/dromic-covid19-sitreps.git
   # Navigate to the newly cloned directory
   cd dromic-covid19-sitreps
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/altcoder/dromic-covid19-sitreps.git
   ```
